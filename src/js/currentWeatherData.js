...
export const currentWeatherData = async (data, key) => {
  ...
  if (data.lat && data.lon) {
    API_URL = `https://api.openweathermap.org/data/2.5/weather?lat=${data.lat}&lon=${data.lon}&appid=932ff401b722db968dc2c5c9a3f5ed38&units=metric`;
  } else {
    API_URL = `https://api.openweathermap.org/data/2.5/weather?q=${data}&appid=932ff401b722db968dc2c5c9a3f5ed38&units=metric`;
  }
