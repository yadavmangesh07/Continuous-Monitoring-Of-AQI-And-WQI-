...
export const weatherForecastData = async (data, key) => {
  ...
  if (data.lat && data.lon) {
    API_URL = `https://api.openweathermap.org/data/2.5/forecast?lat=${data.lat}&lon=${data.lon}&appid=932ff401b722db968dc2c5c9a3f5ed38&units=metric`;
  } else {
    API_URL = `https://api.openweathermap.org/data/2.5/forecast?q=${data}&appid=932ff401b722db968dc2c5c9a3f5ed38&units=metric`;
  }
